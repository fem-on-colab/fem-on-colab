...
rsync -avh --remove-source-files $INSTALL_PREFIX/lib/$PYTHON_VERSION/site-packages/ $INSTALL_PREFIX/lib/$PYTHON_VERSION/dist-packages/
rm -rf $INSTALL_PREFIX/lib/$PYTHON_VERSION/site-packages
cd $INSTALL_PREFIX/lib/$PYTHON_VERSION/dist-packages
...
cd -
find $INSTALL_PREFIX -type f -name '*.pc' -exec sed -i "s|$INSTALL_PREFIX/lib/$PYTHON_VERSION/site-packages|$INSTALL_PREFIX/lib/$PYTHON_VERSION/dist-packages|g" {} \;
find $INSTALL_PREFIX -type f -name '*.cmake' -exec sed -i "s|$INSTALL_PREFIX/lib/$PYTHON_VERSION/site-packages|$INSTALL_PREFIX/lib/$PYTHON_VERSION/dist-packages|g" {} \;
