...
remove_machine_learning_packages () {
    grep -v -e "^accelerate" -e "^arviz==" -e "^chex" -e "^datascience" -e "^dlib" -e "^en-core-web-sm" -e "^fastai" -e "^flax" -e "^gensim" -e "^jax" -e "^kapre" -e "^keras" -e "^Keras" -e "^malloy" -e "^openai" -e "^optax" -e "^orbax" -e "^peft" -e "^pymc==" -e "^scikit" -e "^sentence-transformers" -e "^tensorboard" -e "^tensorflow" -e "^tf_" -e "^timm" -e "^torch" -e "^triton" -e "^xgboost" -h ${1} > ${1}.tmp
    mv ${1}.tmp ${1}
}
