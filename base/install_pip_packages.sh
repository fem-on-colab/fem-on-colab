...
remove_misc_packages () {
    grep -v -e "^betterproto" -e "^bigframes" -e "^bigquery-magics" -e "^cyipopt" -e "^dask" -e "^dataproc" -e "^db-dtypes" -e "^diffusers" -e "^distributed" -e "^earthengine" -e "^eerepr" -e "^esda" -e "^firebase" -e "^gcsfs" -e "^geemap" -e "^geopandas" -e "^giddy" -e "^google" -e "^gradio" -e "^grpc" -e "^gspread" -e "^hf_" -e "^hf-" -e "^highspy" -e "^huggingface" -e "^ibis-framework" -e "^jupyter_kernel_gateway" -e "^kaggle" -e "^keyrings" -e "^libpysal" -e "^mgwr" -e "^model-signing" -e "^music21" -e "^opentelemetry" -e "^pandas-gbq" -e "^polars" -e "^pyarrow" -e "^pydata-google-auth" -e "^PyDrive" -e "^pysal" -e "^pyspark" -e "^raft-dask" -e "^rapids-dask" -e "^sigstore" -e "^spaghetti" -e "^spanner" -e "^spglm" -e "^spint" -e "^splot" -e "^spopt" -e "^spreg" -e "^sqlalchemy" -e "^tokenizers" -h ${1} > ${1}.tmp
    mv ${1}.tmp ${1}
}
