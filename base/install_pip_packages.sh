...
remove_misc_packages () {
    grep -v -e "^bigframes" -e "^bigquery-magics" -e "^db-dtypes" -e"^earthengine" -e "^eerepr" -e "^firebase" -e "^gcsfs" -e "^geemap" -e "^geopandas" -e "^google" -e "^grpc" -e "^gspread" -e "^ibis-framework" -e "^music21" -e "^pandas-gbq" -e "^polars" -e "^pyarrow" -e "^pydata-google-auth" -e "^PyDrive" -e "^pyspark" -h ${1} > ${1}.tmp
    mv ${1}.tmp ${1}
}
